...
async def send_message_to_streamer(
    ...
    await messager_accessor.send_message_to_streamer(streamer_username, current_user, message.message)
...
async def get_send_link(
    ...
    return {"link": f"http://localhost:8000/ws/v1/message/streamer/{tunnel_token.token}"}
